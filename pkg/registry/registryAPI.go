...
func SetRoutes(r *mux.Router, parent *mux.Router, root *mux.Router) {
  ...
  util.AddRouteQ(peersRouter, "/targets/results", getTargetsSummaryResults, "detailed", "{detailed}", "GET")
  util.AddRoute(peersRouter, "/targets/results", getTargetsSummaryResults, "GET")
