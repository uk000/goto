...
func SetRoutes(r *mux.Router, parent *mux.Router, root *mux.Router) {
  ...
  util.AddRoute(lockerPeersRouter, "/{peer}/instances/client/results", getPeersClientSummaryResults, "GET")
  util.AddRoute(lockerPeersRouter, "/{peer}/client/results/details", getPeersClientSummaryResults, "GET")
  util.AddRoute(lockerPeersRouter, "/{peer}/client/results/summary", getPeersClientSummaryResults, "GET")
  util.AddRoute(lockerPeersRouter, "/{peer}/client/results", getPeersClientSummaryResults, "GET")
  util.AddRoute(lockerPeersRouter, "/instances/client/results", getPeersClientSummaryResults, "GET")
  util.AddRoute(lockerPeersRouter, "/client/results/details", getPeersClientSummaryResults, "GET")
  util.AddRoute(lockerPeersRouter, "/client/results/summary", getPeersClientSummaryResults, "GET")
  util.AddRoute(lockerPeersRouter, "/client/results", getPeersClientSummaryResults, "GET")
  util.AddRoute(peersRouter, "/{peer}/instances/client/results", getPeersClientSummaryResults, "GET")
  util.AddRoute(peersRouter, "/{peer}/client/results/details", getPeersClientSummaryResults, "GET")
  util.AddRoute(peersRouter, "/{peer}/client/results/summary", getPeersClientSummaryResults, "GET")
  util.AddRoute(peersRouter, "/{peer}/client/results", getPeersClientSummaryResults, "GET")
  util.AddRoute(peersRouter, "/instances/client/results", getPeersClientSummaryResults, "GET")
  util.AddRoute(peersRouter, "/client/results/details", getPeersClientSummaryResults, "GET")
  util.AddRoute(peersRouter, "/client/results/summary", getPeersClientSummaryResults, "GET")
  util.AddRoute(peersRouter, "/client/results", getPeersClientSummaryResults, "GET")
  ...
  util.AddRouteMultiQ(lockerPeersRouter, "/{peer}/get/{path}", getFromPeerLocker, "GET", "data", "{data}", "level", "{level}")
  util.AddRoute(lockerPeersRouter, "/{peer}/locker/get/{path}", getFromPeerLocker, "GET")
  ...
  util.AddRouteMultiQ(peersRouter, "/{peer}/locker/get/{path}", getFromPeerLocker, "GET", "data", "{data}", "level", "{level}")
  ...
  util.AddRoute(peersRouter, "/jobs/add", addPeerJob, "POST", "PUT")
  ...
  util.AddRoute(peersRouter, "/jobs/{jobs}/remove", removePeerJobs, "POST")
  ...
  util.AddRoute(peersRouter, "/jobs/{jobs}/run", runPeerJobs, "POST")
  util.AddRoute(peersRouter, "/jobs/run/all", runPeerJobs, "POST")
  ...
  util.AddRoute(peersRouter, "/jobs/{jobs}/stop", stopPeerJobs, "POST")
  util.AddRoute(peersRouter, "/jobs/stop/all", stopPeerJobs, "POST")
