...
func SetRoutes(r *mux.Router, parent *mux.Router, root *mux.Router) {
  ...
  util.AddRouteQ(lockerPeersRouter, "/{peer}/client/results", getPeersClientSummaryResults, "detailed", "{detailed}", "GET")
  util.AddRoute(lockerPeersRouter, "/{peer}/client/results", getPeersClientSummaryResults, "GET")
  util.AddRouteQ(lockerPeersRouter, "/client/results", getPeersClientSummaryResults, "detailed", "{detailed}", "GET")
  util.AddRoute(lockerPeersRouter, "/client/results", getPeersClientSummaryResults, "GET")
  util.AddRouteQ(peersRouter, "/{peer}/client/results", getPeersClientSummaryResults, "detailed", "{detailed}", "GET")
  util.AddRoute(peersRouter, "/{peer}/client/results", getPeersClientSummaryResults, "GET")
  util.AddRouteQ(peersRouter, "/client/results", getPeersClientSummaryResults, "detailed", "{detailed}", "GET")
