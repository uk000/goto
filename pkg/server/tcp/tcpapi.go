...
func SetRoutes(r *mux.Router, parent *mux.Router, root *mux.Router) {
  tcpRouter := r.PathPrefix("/tcp").Subrouter()
  util.AddRoute(tcpRouter, "/{port}/configure", configureTCP, "POST")
  util.AddRoute(tcpRouter, "/{port}/timeout/read/{duration}", setConnectionDurationConfig, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/timeout/write/{duration}", setConnectionDurationConfig, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/timeout/idle/{duration}", setConnectionDurationConfig, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/connection/life/{duration}", setConnectionDurationConfig, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/echo/response/delay/{duration}", setConnectionDurationConfig, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/stream/size/{payloadSize}/duration/{duration}/delay/{delay}", setStreamConfig, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/stream/chunk/{chunkSize}/duration/{duration}/delay/{delay}", setStreamConfig, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/stream/chunk/{chunkSize}/count/{chunkCount}/delay/{delay}", setStreamConfig, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/expect/payload/{length}", setExpectedPayloadLength, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/expect/payload", setExpectedPayload, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/validate/payload/{enable}", configurePayloadValidation, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/stream/{enable}", setModes, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/echo/{enable}", setModes, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/conversation/{enable}", setModes, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/silentlife/{enable}", setModes, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/closeatfirst/{enable}", setModes, "PUT", "POST")
