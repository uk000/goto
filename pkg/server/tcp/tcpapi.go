...
func SetRoutes(r *mux.Router, parent *mux.Router, root *mux.Router) {
  ...
  util.AddRoute(tcpRouter, "/{port}/set/validate={enable}", configurePayloadValidation, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/set/stream={enable}", setModes, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/set/echo={enable}", setModes, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/set/conversation={enable}", setModes, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/set/silentlife={enable}", setModes, "PUT", "POST")
  util.AddRoute(tcpRouter, "/{port}/set/closeatfirst={enable}", setModes, "PUT", "POST")
