...
func setRoutes(r *mux.Router, parent *mux.Router, root *mux.Router) {
	...
	util.AddRoute(proxyTargetsRouter, "/{target}/remove", removeProxyTarget, "POST")
	...
	util.AddRoute(httpTargetsRouter, "/{target}/match/query/{key}", addQueryMatch, "PUT", "POST")
	util.AddRoute(httpTargetsRouter, "/{target}/headers/add/{key}={value}", addTargetHeader, "PUT", "POST")
	util.AddRoute(httpTargetsRouter, "/{target}/headers/remove/{key}", removeTargetHeader, "PUT", "POST")
	...
	util.AddRoute(udpProxyRouter, "/{port}/{endpoint}", proxyTCPOrUDP, "POST")
	util.AddRoute(udpProxyRouter, "/{port}/{endpoint}/delay/{delay}", proxyTCPOrUDP, "POST")
	util.AddRoute(udpProxyRouter, "/{port}/delay/{delay}", setUDPDelay, "POST")

	util.AddRoute(proxyTargetsRouter, "/{target}/delay={delay}", setProxyTargetDelay, "PUT", "POST")
	util.AddRoute(proxyTargetsRouter, "/{target}/delay/clear", clearProxyTargetDelay, "POST")
	util.AddRoute(proxyTargetsRouter, "/{target}/drop={drop}", setProxyTargetDrops, "PUT", "POST")
	util.AddRoute(proxyTargetsRouter, "/{target}/drop/clear", clearProxyTargetDrops, "POST")

	util.AddRoute(proxyTargetsRouter, "", getProxyTargets, "GET")
	util.AddRoute(proxyTargetsRouter, "/{target}/report", getProxyTargetReport, "GET")
	util.AddRoute(proxyRouter, "/report/http", getProxyReport, "GET")
	util.AddRoute(proxyRouter, "/report/tcp", getProxyReport, "GET")
	util.AddRoute(proxyRouter, "/report/grpc", getProxyReport, "GET")
	util.AddRoute(proxyRouter, "/report", getProxyReport, "GET")
	util.AddRoute(proxyRouter, "/report/clear", clearProxyReport, "POST")
	util.AddRoute(proxyRouter, "/all/report", getAllProxiesReports, "GET")
	util.AddRoute(proxyRouter, "/all/report/clear", clearAllProxiesReports, "POST")

	util.AddRoute(proxyRouter, "/enable", enableProxy, "POST")
	util.AddRoute(proxyRouter, "/disable", disableProxy, "POST")
}
