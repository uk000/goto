...
func createHybridMessage(id string, toolResults, agentResults, upstreamHeaders map[string]any) a2aproto.Message {
	parts := []a2aproto.Part{}
	...
	parts = append(parts, a2aproto.NewDataPart(upstreamHeaders))
